...
-- Valid bcrypt hash for 'admin123' - $2b$10$rQZ8J5KQJ5JxgkOZrYQx8e = 22 chars salt
...
-- Laptop (4 sản phẩm)
(4, 'MacBook Pro M3', 'MacBook Pro 14 inch M3 Pro 18GB 512GB', 'MacBook Pro M3 Pro chip, màu Space Black, còn bảo hành Apple', 2, 'https://placehold.co/400x400?text=MacBook+Pro+M3', 45000000, 'active', 2),
(5, 'Dell XPS 15', 'Dell XPS 15 9530 i7 32GB 1TB', 'Laptop Dell XPS 15 màn hình 15.6 inch 3.5K OLED', 2, 'https://placehold.co/400x400?text=Dell+XPS+15', 35000000, 'active', 4),
(6, 'MacBook Air M2', 'MacBook Air 13 inch M2 8GB 256GB', 'MacBook Air M2 màu vàng, siêu mỏng nhẹ', 2, 'https://placehold.co/400x400?text=MacBook+Air+M2', 28000000, 'active', 5),
(7, 'ASUS ROG Zephyrus', 'ASUS ROG Zephyrus G14 Ryzen 9', 'Laptop gaming ASUS ROG Zephyrus G14, Ryzen 9 7940HS', 2, 'https://placehold.co/400x400?text=ASUS+ROG', 42000000, 'active', 6),
-- Đồng hồ (4 sản phẩm)
(8, 'Rolex Submariner', 'Rolex Submariner Date 126610LN', 'Đồng hồ Rolex Submariner hàng hiếm, bộ vỏ Oystersteel 41mm', 3, 'https://placehold.co/400x400?text=Rolex+Submariner', 180000000, 'active', 3),
(9, 'Apple Watch Ultra 2', 'Apple Watch Ultra 2 49mm Titanium', 'Apple Watch Ultra 2 màu Titan tự nhiên, dây Alpine Loop', 3, 'https://placehold.co/400x400?text=Apple+Watch+Ultra', 15000000, 'active', 5),
(10, 'Omega Seamaster', 'Omega Seamaster Diver 300M', 'Đồng hồ Omega Seamaster Diver 300M, Automatic', 3, 'https://placehold.co/400x400?text=Omega+Seamaster', 95000000, 'active', 7),
(11, 'Samsung Watch 6', 'Samsung Galaxy Watch 6 Classic 47mm', 'Samsung Galaxy Watch 6 Classic màu đen, viền xoay', 3, 'https://placehold.co/400x400?text=Samsung+Watch+6', 8500000, 'active', 8),
-- Giày (4 sản phẩm)
(12, 'Nike Air Jordan 1', 'Nike Air Jordan 1 Retro High OG Chicago', 'Giày Nike Jordan 1 màu Chicago, size 42, hàng chính hãng', 4, 'https://placehold.co/400x400?text=Jordan+1+Chicago', 8000000, 'active', 4),
(13, 'Adidas Yeezy', 'Adidas Yeezy Boost 350 V2 Zebra', 'Giày Yeezy 350 V2 màu Zebra, size 43, deadstock', 4, 'https://placehold.co/400x400?text=Yeezy+350+Zebra', 6000000, 'active', 5),
(14, 'Nike Dunk Low', 'Nike Dunk Low Panda Black White', 'Giày Nike Dunk Low Panda, size 41, nguyên hộp', 4, 'https://placehold.co/400x400?text=Nike+Dunk+Panda', 4500000, 'active', 9),
(15, 'New Balance 550', 'New Balance 550 x Strangelove', 'Giày New Balance 550 phiên bản giới hạn, size 44', 4, 'https://placehold.co/400x400?text=NB+550', 5500000, 'active', 10),
-- Túi xách (3 sản phẩm)
(16, 'Louis Vuitton Speedy', 'Louis Vuitton Speedy Bandoulière 25', 'Túi LV Speedy 25 monogram, dây đeo vai, hàng chính hãng', 5, 'https://placehold.co/400x400?text=LV+Speedy', 45000000, 'active', 2),
(17, 'Gucci Marmont', 'Gucci GG Marmont Small Shoulder Bag', 'Túi Gucci Marmont nhỏ màu beige, khóa kim loại vàng', 5, 'https://placehold.co/400x400?text=Gucci+Marmont', 28000000, 'active', 3),
(18, 'Chanel Classic Flap', 'Chanel Classic Flap Medium', 'Túi Chanel Classic Flap Medium đen, khóa kim loại vàng', 5, 'https://placehold.co/400x400?text=Chanel+Flap', 120000000, 'active', 11),
-- Trang sức (3 sản phẩm)
(19, 'Vòng tay Cartier', 'Cartier Love Bracelet Size 17', 'Vòng tay Cartier Love bằng vàng hồng 18K, size 17', 6, 'https://placehold.co/400x400?text=Cartier+Love', 85000000, 'active', 4),
(20, 'Nhẫn kim cương', 'Nhẫn kim cương 1 carat GIA', 'Nhẫn kim cương 1 carat chứng nhận GIA, vàng trắng 18K', 6, 'https://placehold.co/400x400?text=Diamond+Ring', 120000000, 'active', 5),
(21, 'Dây chuyền Van Cleef', 'Van Cleef & Arpels Alhambra', 'Dây chuyền Van Cleef Alhambra màu vàng, đá onyx', 6, 'https://placehold.co/400x400?text=VC%26A', 75000000, 'active', 12),
-- Đồ gia dụng (2 sản phẩm)
(22, 'Robot hút bụi Dyson', 'Dyson 360 Heurist', 'Robot hút bụi Dyson 360 Heurist, hút siêu sạch', 7, 'https://placehold.co/400x400?text=Dyson+Robot', 18000000, 'active', 6),
(23, 'Máy lọc không khí Xiaomi', 'Xiaomi Air Purifier 4 Pro', 'Máy lọc không khí Xiaomi 4 Pro, diện tích 60m²', 7, 'https://placehold.co/400x400?text=Xiaomi+Air+Purifier', 5500000, 'active', 13),
-- Nghệ thuật (1 sản phẩm)
(24, 'Tranh sơn dầu', 'Tranh sơn dầu phong cảnh Việt Nam', 'Tranh sơn dầu kích thước 1m x 1.5m, họa sĩ nổi tiếng', 10, 'https://placehold.co/400x400?text=Tranh+Son+dau', 35000000, 'active', 7);
...
-- User 2 actions
(2, 'login', 'Đăng nhập thành công', '192.168.1.100', DATE_SUB(NOW(), INTERVAL 5 HOUR)),
(2, 'create_auction', 'Tạo phiên đấu giá iPhone 15 Pro Max', '192.168.1.100', DATE_SUB(NOW(), INTERVAL 4 HOUR)),
(2, 'bid', 'Đặt giá 28,000,000 VNĐ cho iPhone 15 Pro Max', '192.168.1.100', DATE_SUB(NOW(), INTERVAL 15 MINUTE)),
(2, 'deposit', 'Nạp tiền 25,000,000 VNĐ', '192.168.1.100', DATE_SUB(NOW(), INTERVAL 2 DAY)),
(2, 'update_profile', 'Cập nhật số điện thoại', '192.168.1.100', DATE_SUB(NOW(), INTERVAL 3 DAY)),
-- User 3 actions
(3, 'login', 'Đăng nhập thành công', '192.168.1.101', DATE_SUB(NOW(), INTERVAL 3 HOUR)),
(3, 'bid', 'Đặt giá 195,000,000 VNĐ cho Rolex Submariner', '192.168.1.101', DATE_SUB(NOW(), INTERVAL 30 MINUTE)),
(3, 'bid', 'Đặt giá 22,000,000 VNĐ cho Samsung S24 Ultra', '192.168.1.101', DATE_SUB(NOW(), INTERVAL 10 MINUTE)),
(3, 'create_auction', 'Tạo phiên đấu giá Samsung S24 Ultra', '192.168.1.101', DATE_SUB(NOW(), INTERVAL 6 HOUR)),
-- User 4 actions
(4, 'login', 'Đăng nhập thành công', '192.168.1.102', DATE_SUB(NOW(), INTERVAL 4 HOUR)),
(4, 'register', 'Đăng ký tài khoản mới', '192.168.1.102', DATE_SUB(NOW(), INTERVAL 20 DAY)),
(4, 'bid', 'Đặt giá 37,000,000 VNĐ cho Dell XPS 15', '192.168.1.102', DATE_SUB(NOW(), INTERVAL 20 MINUTE)),
(4, 'deposit', 'Nạp tiền 25,000,000 VNĐ', '192.168.1.102', DATE_SUB(NOW(), INTERVAL 4 DAY)),
-- User 5 actions
(5, 'login', 'Đăng nhập thành công', '192.168.1.103', DATE_SUB(NOW(), INTERVAL 2 HOUR)),
(5, 'bid', 'Đặt giá 9,500,000 VNĐ cho Nike Air Jordan 1', '192.168.1.103', DATE_SUB(NOW(), INTERVAL 5 MINUTE)),
(5, 'bid', 'Đặt giá 16,500,000 VNĐ cho Apple Watch Ultra 2', '192.168.1.103', DATE_SUB(NOW(), INTERVAL 15 MINUTE)),
(5, 'create_auction', 'Tạo phiên đấu giá Apple Watch Ultra 2', '192.168.1.103', DATE_SUB(NOW(), INTERVAL 8 HOUR)),
-- User 6 actions
(6, 'login', 'Đăng nhập thành công', '192.168.1.104', DATE_SUB(NOW(), INTERVAL 1 HOUR)),
(6, 'bid', 'Đặt giá 49,000,000 VNĐ cho MacBook Pro M3', '192.168.1.104', DATE_SUB(NOW(), INTERVAL 45 MINUTE)),
(6, 'deposit', 'Nạp tiền 35,000,000 VNĐ', '192.168.1.104', DATE_SUB(NOW(), INTERVAL 3 DAY)),
-- User 7 actions
(7, 'login', 'Đăng nhập thành công', '192.168.1.105', DATE_SUB(NOW(), INTERVAL 30 MINUTE)),
(7, 'bid', 'Đặt giá 30,000,000 VNĐ cho MacBook Air M2', '192.168.1.105', DATE_SUB(NOW(), INTERVAL 30 MINUTE)),
-- User 8 actions
(8, 'login', 'Đăng nhập thành công', '192.168.1.106', DATE_SUB(NOW(), INTERVAL 6 HOUR)),
(8, 'register', 'Đăng ký tài khoản mới', '192.168.1.106', DATE_SUB(NOW(), INTERVAL 10 DAY)),
(8, 'bid', 'Đặt giá 13,500,000 VNĐ cho Xiaomi 14 Pro', '192.168.1.106', DATE_SUB(NOW(), INTERVAL 10 MINUTE)),
-- User 9 actions
(9, 'login', 'Đăng nhập thành công', '192.168.1.107', DATE_SUB(NOW(), INTERVAL 4 HOUR)),
(9, 'bid', 'Đặt giá 5,000,000 VNĐ cho Nike Dunk Low', '192.168.1.107', DATE_SUB(NOW(), INTERVAL 10 MINUTE)),
(9, 'bid', 'Đặt giá 9,200,000 VNĐ cho Samsung Galaxy Watch 6', '192.168.1.107', DATE_SUB(NOW(), INTERVAL 5 MINUTE)),
-- User 10 actions
(10, 'login', 'Đăng nhập thành công', '192.168.1.108', DATE_SUB(NOW(), INTERVAL 2 HOUR)),
(10, 'bid', 'Đặt giá 6,000,000 VNĐ cho New Balance 550', '192.168.1.108', DATE_SUB(NOW(), INTERVAL 15 MINUTE)),
-- User 11 actions
(11, 'login', 'Đăng nhập thành công', '192.168.1.109', DATE_SUB(NOW(), INTERVAL 1 HOUR)),
(11, 'create_auction', 'Tạo phiên đấu giá Chanel Classic Flap', '192.168.1.109', DATE_SUB(NOW(), INTERVAL 3 HOUR)),
(11, 'bid', 'Đặt giá 130,000,000 VNĐ cho Chanel Classic Flap', '192.168.1.109', DATE_SUB(NOW(), INTERVAL 45 MINUTE)),
-- User 12 actions
